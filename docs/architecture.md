...
The watcher and daemon share `bin/fm-classify-lib.sh` for captain-relevant status verbs, authenticated PR-wait classification, declared-external-wait vocabulary, and status-scan primitives.
