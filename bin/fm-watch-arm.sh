...
# daemon owns triage and the watcher exits on every wake except an authenticated
# PR wait. Reliability depends on arming through a mechanism that SURVIVES the
